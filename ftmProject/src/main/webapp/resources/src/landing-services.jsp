...
<head>
  ...
  <!-- Title -->
  <title>Services | Unify - Multipurpose Responsive Template</title>
      ...
      <div class="container content-space-t-3">
        <div class="row justify-content-lg-between align-items-md-center">
          <div class="col-md-6 col-lg-5 mb-5 mb-lg-0">
            <h1 class="display-4 mb-5">Start your journey with <span class="text-primary">Unify</span></h1>
              ...
              <figcaption class="blockquote-footer">
                <div class="d-flex align-items-center">
                  <div class="flex-shrink-0">
                    <img class="avatar avatar-circle" src="${path}/resources/src/assets/img/160x160/img10.jpg" alt="Image Description">
                  </div>
          ...
          <div class="col-md-6 col-lg-5 d-none d-md-block">
            <div class="row gx-3 me-lg-n10">
              <div class="col-3 offset-1 align-self-end mb-3">
                <img class="img-fluid" src="${path}/resources/src/assets/svg/components/dots-warning.svg" alt="Image Description">
              </div>
              <!-- End Col -->

              <div class="col-8 mb-3">
                <img class="img-fluid rounded-3" src="${path}/resources/src/assets/img/950x950/img4.jpg" alt="Image Description">
              </div>
              <!-- End Col -->

              <div class="col-6">
                <img class="img-fluid rounded-3" src="${path}/resources/src/assets/img/950x950/img5.jpg" alt="Image Description">
              </div>
              <!-- End Col -->

              <div class="col-5">
                <img class="img-fluid" src="${path}/resources/src/assets/svg/components/card-11.svg" alt="Image Description">
              </div>
              <!-- End Col -->
            </div>
            <!-- End Row -->
              ...
              <div class="position-relative">
                ...
                <div class="tab-content" id="featuresTabContent">
                  <div class="tab-pane fade show active" id="featuresOne" role="tabpanel" aria-labelledby="featuresOne-tab">
                    <img class="img-fluid shadow rounded-3" src="${path}/resources/src/assets/img/mockups/img7.png" alt="Image Description">
                  </div>

                  <div class="tab-pane fade" id="featuresTwo" role="tabpanel" aria-labelledby="featuresTwo-tab">
                    <img class="img-fluid shadow rounded-3" src="${path}/resources/src/assets/img/mockups/img8.png" alt="Image Description">
                  </div>

                  <div class="tab-pane fade" id="featuresThree" role="tabpanel" aria-labelledby="featuresThree-tab">
                    <img class="img-fluid shadow rounded-3" src="${path}/resources/src/assets/img/mockups/img4.png" alt="Image Description">
                  </div>
                </div>
                <!-- End Tab Content -->
    ...
    <div class="container content-space-b-2 content-space-b-lg-3">
      ...
      <div class="row align-items-center">
        <div class="col d-none d-md-block">
          <img class="img-fluid rounded-3" src="${path}/resources/src/assets/img/580x480/img3.jpg" alt="Image Description">
        </div>
        <!-- End Col -->
        
        <div class="col">
          <img class="img-fluid rounded-3" src="${path}/resources/src/assets/img/350x700/img2.jpg" alt="Image Description">
        </div>
        <!-- End Col -->

        <div class="col">
          <img class="img-fluid rounded-3" src="${path}/resources/src/assets/img/400x700/img2.jpg" alt="Image Description">
        </div>
        <!-- End Col -->

        <div class="col d-none d-sm-block">
          <img class="img-fluid rounded-3" src="${path}/resources/src/assets/img/500x650/img5.jpg" alt="Image Description">
        </div>
        <!-- End Col -->
      </div>
      <!-- End Row -->
      ...
      <ul class="list-equal-height list-equal-height-4-cols">
        <li class="list-equal-height-item">
          <div class="text-center">
            ...
            <p>Unify is an <span class="fw-bold text-dark">incredibly beautiful</span> and mobile-first project on the web.</p>
          </div>
        </li>
        ...
        <li class="list-equal-height-item">
          <div class="text-center">
            ...
            <p>Unify is not only for developers but also for designers, and <span class="fw-bold text-dark">includes a Figma</span> file.</p>
          </div>
        </li>
        ...
        <li class="list-equal-height-item">
          <div class="text-center">
            ...
            <p><span class="fw-bold text-dark">Whether you're a startup</span> or a global enterprise, learn how to integrate with Unify.</p>
          </div>
        </li>
        ...
        <li class="list-equal-height-item">
          <div class="text-center">
            ...
            <p>Use Unify thoroughly thought and automated libraries to <span class="fw-bold text-dark">manage your businesses</span>.</p>
          </div>
        </li>
        ...
        <li class="list-equal-height-item">
          <div class="text-center">
            ...
            <p>Unify template can be <span class="fw-bold text-dark">easily customized</span> with its cutting-edge components.</p>
          </div>
        </li>
        ...
        <li class="list-equal-height-item">
          <div class="text-center">
            ...
            <p>Every component and plugin is <span class="fw-bold text-dark">well documented</span> with live examples.</p>
          </div>
        </li>
        ...
        <li class="list-equal-height-item">
          <div class="text-center">
            <div class="mb-3">
              <i class="bi-patch-check fs-1 text-dark"></i>
            </div>
            <p>Automate <span class="fw-bold text-dark">best strategies</span> and focus more on generating hq creatives.</p>
          </div>
        </li>
        ...
        <li class="list-equal-height-item">
          <div class="text-center">
            <div class="mb-3">
              <i class="bi-lightbulb fs-1 text-dark"></i>
            </div>
            <p>Stop inefficient budget spend or pour more into a <span class="fw-bold text-dark">winning</span> ad when needed.</p>
          </div>
        </li>
      </ul>
      <!-- End List -->
        ...
        <div class="col-auto">
          <div class="text-center">
            <div class="avatar avatar-4x3 shadow-sm rounded-3 p-3 mx-auto">
              <img class="avatar-img" src="${path}/resources/src/assets/svg/components/plus-icon.svg" alt="Image Description">
            </div>
          </div>
        </div>
        <!-- End Col -->
      ...
      <div class="container position-relative content-space-2 content-space-lg-3">
        <div class="row align-items-md-center mb-7">
          <div class="col-md-6 mb-3 mb-md-0">
            <h2 class="text-white">Loved by business and individuals across the globe</h2>
          </div>
          <!-- End Col -->
          ...
          <div class="js-swiper-testimonials swiper swiper-equal-height">
            <div class="swiper-wrapper">
                  ...
                  <div class="card-footer bg-light">
                    ...
                    <div class="d-sm-flex align-items-sm-center">
                      <div class="flex-shrink-0 mb-3 mb-sm-0">
                        <img class="avatar avatar-circle" src="${path}/resources/src/assets/img/160x160/img7.jpg" alt="Image Description">
                      </div>
              ...
              <div class="swiper-slide">
                ...
                <div class="card">
                  <div class="card-body">
                    <p class="card-text fs-3"><em>" With Unify, we're able to easily track our performance in full detail. It's become an essential tool for us to grow and engage with our audience. "</em></p>
                  </div>
                  ...
                  <div class="card-footer bg-light">
                    ...
                    <div class="d-sm-flex align-items-sm-center">
                      <div class="flex-shrink-0 mb-3 mb-sm-0">
                        <img class="avatar avatar-circle" src="${path}/resources/src/assets/img/160x160/img6.jpg" alt="Image Description">
                      </div>
                      <div class="flex-grow-1 ms-sm-3">
                        <h6 class="mb-0">Josh Tyson</h6>
                        <span class="card-text fs-5">Product Manager | Capsule</span>
                      </div>
                    </div>
                    <!-- End Media -->
                  </div>
              ...
              <div class="swiper-slide">
                ...
                <div class="card">
                  <div class="card-body">
                    <p class="card-text fs-3"><em>" In September, I will be using this theme for 2 years. I went through multiple updates and changes and I'm very glad to see the consistency and effort made by the team. "</em></p>
                  </div>
                  ...
                  <div class="card-footer bg-light">
                    ...
                    <div class="d-sm-flex align-items-sm-center">
                      ...
                      <div class="flex-grow-1 ms-sm-3">
                        <h6 class="mb-0">Luisa</h6>
                        <span class="card-text fs-5">Senior Director of Operations | Fitbit</span>
                      </div>
                    </div>
                    <!-- End Media -->
                  </div>
              ...
              <div class="swiper-slide">
                ...
                <div class="card">
                  <div class="card-body">
                    <p class="card-text fs-3"><em>" Refreshing and Thought provoking design and it changes my view about how I design the websites. Great typography, modern clean white design, nice tones of the color. "</em></p>
                  </div>
                  ...
                  <div class="card-footer bg-light">
                    ...
                    <div class="d-sm-flex align-items-sm-center">
                      <div class="flex-shrink-0 mb-3 mb-sm-0">
                        <img class="avatar avatar-circle" src="${path}/resources/src/assets/img/160x160/img9.jpg" alt="Image Description">
                      </div>
                      <div class="flex-grow-1 ms-sm-3">
                        <h6 class="mb-0">Alisa Williams</h6>
                        <span class="card-text fs-5">Entrepreneur | Happy customer</span>
                      </div>
                    </div>
                    <!-- End Media -->
                  </div>
        ...
        <!-- SVG Shape -->
        <figure class="position-absolute bottom-0 end-0 d-none d-lg-block mb-10" style="width: 17rem; margin-right: -8rem;">
          <img class="img-fluid" src="${path}/resources/src/assets/svg/components/three-arrows-1-light.svg" alt="Image Description">
        </figure>
        <!-- End SVG Shape -->
      </div>
    </div>
    ...
    <div class="container content-space-2 content-space-lg-3">
      ...
      <div class="row align-items-md-center mb-7">
        ...
        <div class="col-md-6">
          <div class="ps-lg-7">
            <div class="mb-3">
              <img class="avatar avatar-xl avatar-4x3" src="${path}/resources/src/assets/svg/brands/amazon-dark.svg" alt="Logo">
            </div>
      ...
      <div class="row row-cols-1 row-cols-sm-2 row-cols-md-3">
        <div class="col mb-5 mb-md-0">
          ...
          <a class="card card-ghost card-transition-zoom h-100" href="#">
            ...
            <div class="card-body">
              <div class="mb-3">
                <img class="avatar avatar-lg avatar-4x3" src="${path}/resources/src/assets/svg/brands/fitbit-dark.svg" alt="Logo">
              </div>
        ...
        <div class="col">
          ...
          <a class="card card-ghost card-transition-zoom h-100" href="#">
            <div class="card-transition-zoom-item">
              <img class="card-img" src="${path}/resources/src/assets/img/580x480/img4.jpg" alt="Image Description">
            </div>

            <div class="card-body">
              <div class="mb-3">
                <img class="avatar avatar-lg avatar-4x3" src="${path}/resources/src/assets/svg/brands/capsule-dark.svg" alt="Logo">
              </div>
