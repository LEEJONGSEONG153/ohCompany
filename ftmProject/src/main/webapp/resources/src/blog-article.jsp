...
<head>
  ...
  <!-- Title -->
  <title>Blog: Article | Unify - Multipurpose Responsive Template</title>
...
<%--  })--%>
  <jsp:include page="${path}/resources/src/partials/navbar/main-absolute-top.jsp">
    ...
    <jsp:param name="link" value="blog-article.jsp"/>
  </jsp:include>
  <!-- ========== END HEADER ========== -->
  ...
  <main id="content" role="main">
    ...
    <div class="bg-gradient-to-bottom-sm-light">
      <div class="container content-space-t-3">
          ...
          <div class="col-lg-8">
            ...
            <div class="d-flex align-items-center mb-4">
              ...
              <div class="flex-grow-1 ms-3">
                <h6 class="mb-0">
                  <a class="link link-dark" href="${path}/resources/src/blog-author-profile.jsp">Louise Donadieu</a>
                </h6>
        ...
        <div class="row justify-content-lg-center">
          <div class="col-lg-10">
            <img class="img-fluid" src="${path}/resources/src/assets/img/1920x1080/img1.jpg" alt="Image Description">
          </div>
          <!-- End Col -->
        </div>
        <!-- End Row -->
    ...
    <div class="container content-space-2 content-space-lg-3">
      ...
      <div class="row mb-5">
        <div class="col-md-10 col-lg-8 offset-md-1 offset-lg-2">
          <img class="img-fluid" src="${path}/resources/src/assets/img/1920x1080/img2.jpg" alt="Image Description">
        </div>
        <!-- End Col -->
      </div>
      <!-- End Row -->
      ...
      <div class="row mb-5">
        <div class="col-md-10 col-lg-8 offset-md-1 offset-lg-2">
          <img class="img-fluid" src="${path}/resources/src/assets/img/1920x1080/img3.jpg" alt="Image Description">
        </div>
        <!-- End Col -->
      </div>
      <!-- End Row -->
          ...
          <div class="col-lg-8">
            ...
            <div class="d-sm-flex">
              <div class="flex-shrink-0 mb-3 mb-sm-0">
                <img class="avatar avatar-xl avatar-circle" src="${path}/resources/src/assets/img/160x160/img10.jpg" alt="Image Description">
              </div>
              ...
              <div class="flex-grow-1 ms-sm-4">
                ...
                <div class="d-flex justify-content-between align-items-center mb-2">
                  <h4 class="mb-0">
                    <a class="text-dark" href="${path}/resources/src/blog-author-profile.jsp">Louise Donadieu</a>
                  </h4>
        ...
        <div class="col-lg-8">
          ...
          <ul class="list-comment">
            ...
            <li class="list-comment-item">
              ...
              <div class="d-flex align-items-center mb-3">
                <div class="flex-shrink-0">
                  <img class="avatar avatar-circle" src="${path}/resources/src/assets/img/160x160/img8.jpg" alt="Image Description">
                </div>
    ...
    <div class="container content-space-2 content-space-lg-3">
      ...
      <div class="w-lg-65 text-center mx-lg-auto mb-7">
        ...
        <p>Get special offers on the latest developments from Unify.</p>
      </div>
      <!-- End Heading -->
