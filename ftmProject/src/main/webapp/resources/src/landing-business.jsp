...
<head>
  ...
  <!-- Title -->
  <title>Business | Unify - Multipurpose Responsive Template</title>
      ...
      <div class="container position-relative content-space-t-3 content-space-b-2">
        ...
        <div class="w-lg-65 mx-lg-auto">
          ...
          <figure class="position-absolute top-50 start-0 translate-middle-y d-none d-md-block" style="width: 14rem; margin-left: -10rem;">
            <img class="img-fluid" src="${path}/resources/src/assets/svg/components/three-arrows-2.svg" alt="Image Description">
          </figure>
          <!-- End SVG Shape -->
        </div>
      </div>
        ...
        <div class="row align-items-lg-center">
          <div class="col-lg-7 mb-10 mb-lg-0">
            <div class="position-relative">
              <img class="img-fluid w-75 rounded-3" src="${path}/resources/src/assets/img/500x650/img1.jpg" alt="Image Description">

              <div class="position-absolute bottom-0 end-0 mb-n10 me-5">
                <div class="d-flex justify-content-end">
                  <img class="img-fluid w-65 shadow rounded-3" src="${path}/resources/src/assets/img/mockups/img4.png" alt="Image Description">
                </div>
              </div>

              <!-- SVG Shape -->
              <figure class="position-absolute bottom-0 start-0 zi-n1 mb-n7 ms-n7" style="width: 10rem;">
                <img class="img-fluid" src="${path}/resources/src/assets/svg/components/dots-success.svg" alt="Image Description">
              </figure>
              <!-- End SVG Shape -->
            </div>
          </div>
            ...
            <div class="col-lg-7 order-lg-2 mb-5 mb-lg-0">
              <div class="position-relative">
                <div class="w-75 ms-auto">
                  <img class="img-fluid rounded-3" src="${path}/resources/src/assets/img/500x650/img2.jpg" alt="Image Description">
                </div>

                <div class="position-absolute bottom-0 start-0 mb-10 ms-5">
                  <img class="img-fluid w-75 shadow rounded-3" src="${path}/resources/src/assets/img/mockups/img5.png" alt="Image Description">
                </div>
    ...
    <div class="overflow-hidden content-space-t-lg-1 content-space-b-lg-2">
      <div class="container content-space-2 content-space-b-lg-3">
        <div class="row align-items-lg-center">
          <div class="col-lg-7 mb-10 mb-lg-0">
            <div class="position-relative">
              <img class="img-fluid w-75 rounded-3" src="${path}/resources/src/assets/img/500x650/img3.jpg" alt="Image Description">

              <div class="position-absolute bottom-0 end-0 mb-n10 me-5">
                <div class="d-flex justify-content-end">
                  <img class="img-fluid w-65 shadow rounded-3" src="${path}/resources/src/assets/img/mockups/img6.png" alt="Image Description">
                </div>
              </div>
          ...
          <div class="col-lg-5 mt-7 mt-sm-10 mt-lg-0">
            <div class="ps-lg-5">
              ...
              <div class="row border-bottom pb-3 mb-3">
                <div class="col-6">
                  <a class="link link-secondary link-pointer" href="#">Unify Wallet app</a>
                </div>
                <!-- End Col -->
                
                <div class="col-6">
                  <a class="link link-secondary link-pointer" href="#">Unify debit card</a>
                </div>
                <!-- End Col -->
              </div>
              <!-- End Row -->
              ...
              <div class="row border-bottom pb-3 mb-3">
                ...
                <div class="col-6">
                  <a class="link link-secondary link-pointer" href="#">Unify Cashout</a>
                </div>
                <!-- End Col -->
              </div>
              <!-- End Row -->
    ...
    <div class="container content-space-b-1 content-space-b-lg-3">
      <div class="row align-items-md-center mb-7">
        <div class="col-md mb-3 mb-md-0">
          <h2>A brief <br class="d-none d-sm-block">history of Unify</h2>
        </div>
        <!-- End Col -->
