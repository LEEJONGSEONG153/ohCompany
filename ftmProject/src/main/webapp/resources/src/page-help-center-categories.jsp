...
<head>
  ...
  <!-- Title -->
  <title>Help Center: Categories | Unify - Multipurpose Responsive Template</title>
...
<%--    "category": "",--%>
<%--    "link": "page-help-center-categories.html"--%>
<%--  })--%>
  <jsp:include page="${path}/resources/src/partials/navbar/main.jsp">
    <jsp:param name="category" value=""/>
    <jsp:param name="link" value="page-help-center-categories.jsp"/>
  </jsp:include>
  <!-- ========== END HEADER ========== -->
            ...
            <li>
              ...
              <div class="d-sm-flex">
                ...
                <div class="flex-grow-1 ms-sm-3">
                  ...
                  <a class="link" href="${path}/resources/src/page-help-center-article.html">Read more <i class="bi-chevron-right small ms-1"></i></a>
                </div>
              </div>
              <!-- End Media -->
            </li>
