...
<head>
  ...
  <!-- Title -->
  <title>Blog: Grid | Unify - Multipurpose Responsive Template</title>
...
<%--  })--%>
  <jsp:include page="${path}/resources/src/partials/navbar/main-absolute-top.jsp">
    ...
    <jsp:param name="link" value="blog-grid.jsp"/>
  </jsp:include>
  <!-- ========== END HEADER ========== -->
      ...
      <div class="container content-space-t-3 content-space-b-1 content-space-b-lg-3">
        <div class="row justify-content-md-between align-items-md-center">
          <div class="col-md-5 mb-5 mb-md-0">
            <div class="mb-3">
              <span class="badge bg-soft-dark text-dark">Business insight</span>
            </div>
            <div class="mb-5">
              <h2 class="h1"><a class="text-dark" href="#">How to get buy-in and budget for direct hiring</a></h2>
            </div>
            ...
            <div class="d-flex align-items-center mb-3">
              ...
              <div class="flex-grow-1 ms-3">
                <h5 class="mb-1"><a class="text-dark" href="${path}/resources/src/blog-author-profile.html">Louise Donadieu</a></h5>
                <span class="d-block small text-muted">Strategic Marketing Consultant</span>
              </div>
            </div>
            <!-- End Media -->

            <a class="link link-pointer" href="${path}/resources/src/blog-article.html">Read more</a>
          </div>
          <!-- End Col -->

          <div class="col-md-7 col-lg-6">
            <div class="position-relative">
              <img class="img-fluid rounded-3" src="${path}/resources/src/assets/img/950x950/img6.jpg" alt="Image Description">
    ...
    <div class="overflow-hidden">
      <div class="container content-space-1 content-space-b-lg-3">
        ...
        <div class="row row-cols-1 row-cols-sm-2 row-cols-lg-3 gx-7">
          ...
          <div class="col mb-7 mb-md-10">
            <!-- Card -->
            <a class="card card-borderless card-transition h-100 bg-img-end" href="${path}/resources/src/blog-article.html" style="background-image: url(${path}/resources/src/assets/svg/components/card-12.svg); min-height: 15rem;">
              <div class="card-body">
                <div class="d-flex justify-content-between flex-column h-100">
                  <div class="mb-1">
                    <span class="card-title fs-3 text-white"><span class="fw-bold">Unify</span> Press publishes books about economic and technological advancement.</span>
                  </div>
                  <div class="mt-1">
