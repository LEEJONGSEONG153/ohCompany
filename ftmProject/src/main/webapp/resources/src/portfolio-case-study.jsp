...
<head>
  ...
  <!-- Title -->
  <title>Portfolio: Case Study | Unify - Multipurpose Responsive Template</title>
  ...
  <main id="content" role="main">
    ...
    <div class="bg-gradient-to-bottom-sm-light">
      <div class="container content-space-t-3 content-space-t-lg-4">
        <div class="w-lg-65 text-center mx-lg-auto mb-5 mb-lg-10">
          <span class="text-cap">Case study</span>
          <h1>UV Violet glass</h1>
          <p class="lead">UV offers online retailers a suite of services including payments, marketing, shipping and customer engagement tools.</p>
        </div>
    ...
    <div class="container content-space-1 content-space-lg-3">
      <div class="row">
        ...
        <div class="col-md-8">
          ...
          <div class="mb-7">
            <h5>Solution</h5>
            <p>UV partnered with Unify to completely rebrand and launch UV's new website, marketing platform and product suite.</p>
          </div>
        </div>
        <!-- End Col -->
      </div>
      ...
      <div class="my-4">
        <img class="img-fluid" src="${path}/resources/src/assets/img/1920x1080/img8.jpg" alt="Image Description">
      </div>

      <div class="row mb-7">
        <div class="col-sm-6 mb-4 mb-sm-0">
          <img class="img-fluid" src="${path}/resources/src/assets/img/580x480/img25.jpg" alt="Image Description">
        </div>
        <!-- End Col -->

        <div class="col-sm-6">
          <img class="img-fluid" src="${path}/resources/src/assets/img/580x480/img26.jpg" alt="Image Description">
        </div>
        <!-- End Col -->
      </div>
      <!-- End Row -->
      ...
      <div class="my-4">
        <img class="img-fluid" src="${path}/resources/src/assets/img/1920x1080/img9.jpg" alt="Image Description">
      </div>

      <div class="row mb-7">
        <div class="col-sm-6 mb-4 mb-sm-0">
          <img class="img-fluid" src="${path}/resources/src/assets/img/580x480/img27.jpg" alt="Image Description">
        </div>
        <!-- End Col -->

        <div class="col-sm-6">
          <img class="img-fluid" src="${path}/resources/src/assets/img/580x480/img28.jpg" alt="Image Description">
        </div>
        <!-- End Col -->
      </div>
      <!-- End Row -->
      ...
      <div class="mt-4 mb-7">
        <img class="img-fluid" src="${path}/resources/src/assets/img/1920x1080/img10.jpg" alt="Image Description">
      </div>
    ...
    <!-- Grid - Customer Story -->
    <div class="container content-space-b-lg-1 overflow-hidden">
      <!-- Heading -->
