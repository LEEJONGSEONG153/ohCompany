...
<head>
  ...
  <!-- Title -->
  <title>Portfolio: Modern | Unify - Multipurpose Responsive Template</title>
  ...
  <main id="content" role="main">
          ...
          <div class="js-swiper-portfolio-modern-hero swiper">
            <div class="swiper-wrapper">
              <div class="swiper-slide">
                <img class="img-fluid" src="${path}/resources/src/assets/img/1920x1080/img4.jpg" alt="Image Description">
              </div>
              <!-- End Slide -->

              <div class="swiper-slide">
                <img class="img-fluid" src="${path}/resources/src/assets/img/1920x1080/img5.jpg" alt="Image Description">
              </div>
              <!-- End Slide -->

              <div class="swiper-slide">
                <img class="img-fluid" src="${path}/resources/src/assets/img/1920x1080/img6.jpg" alt="Image Description">
              </div>
              <!-- End Slide -->

              <div class="swiper-slide">
                <img class="img-fluid" src="${path}/resources/src/assets/img/1920x1080/img7.jpg" alt="Image Description">
              </div>
              <!-- End Slide -->
            </div>
          </div>
    ...
    <div class="container content-space-t-2 content-space-t-lg-3 overflow-hidden">
      ...
      <div class="row row-cols-1 row-cols-sm-2 gx-7">
        <div class="col mb-5">
          <!-- Card -->
          <a class="card card-ghost card-transition-zoom h-100" href="${path}/resources/src/portfolio-case-study.html">
            <div class="card-pinned card-transition-zoom-item">
              <img class="card-img" src="${path}/resources/src/assets/img/580x480/img23.jpg" alt="Image Description">
        ...
        <div class="col mb-5">
          ...
          <a class="card card-ghost card-transition-zoom h-100" href="${path}/resources/src/portfolio-case-study.html">
            <div class="card-transition-zoom-item">
              <img class="card-img" src="${path}/resources/src/assets/img/580x480/img22.jpg" alt="Image Description">
            </div>
        ...
        <div class="col mb-5">
          ...
          <a class="card card-ghost card-transition-zoom h-100" href="${path}/resources/src/portfolio-case-study.html">
            <div class="card-transition-zoom-item">
              <img class="card-img" src="${path}/resources/src/assets/img/580x480/img21.jpg" alt="Image Description">
            </div>

            <div class="card-body">
              <h4>Nova – <span class="fw-medium">Responsive WebApp UI Kit</span></h4>
              <p class="card-text">Admin &amp; Dashboard</p>
            </div>
          </a>
          <!-- End Card -->
        ...
        <div class="col mb-5">
          ...
          <a class="card card-ghost card-transition-zoom h-100" href="${path}/resources/src/portfolio-case-study.html">
            <div class="card-pinned card-transition-zoom-item">
              <img class="card-img" src="${path}/resources/src/assets/img/580x480/img20.jpg" alt="Image Description">
              <span class="badge bg-dark text-white card-pinned-top-end">New addition</span>
            </div>

            <div class="card-body">
              <h4>Space – <span class="fw-medium">Multipurpose Template + UI Kit</span></h4>
        ...
        <div class="col mb-5">
          ...
          <a class="card card-ghost card-transition-zoom h-100" href="${path}/resources/src/portfolio-case-study.html">
            <div class="card-transition-zoom-item">
              <img class="card-img" src="${path}/resources/src/assets/img/580x480/img19.jpg" alt="Image Description">
            </div>
        ...
        <div class="col mb-5">
          ...
          <a class="card card-ghost card-transition-zoom h-100" href="${path}/resources/src/portfolio-case-study.html">
            <div class="card-transition-zoom-item">
              <img class="card-img" src="${path}/resources/src/assets/img/580x480/img24.jpg" alt="Image Description">
            </div>
      ...
      <div class="text-center">
        <a class="btn btn-white btn-pointer" href="${path}/resources/src/page-customer-stories.html">View all case studies</a>
      </div>
    </div>
    <!-- End Card Grid -->
            ...
            <div class="card-body">
              ...
              <div class="d-flex">
                ...
                <div class="flex-grow-1 ms-5">
                  ...
                  <p class="card-text">We are actively looking for creative minds who will thrive with the Unify team.</p>
                  <a class="card-link" href="${path}/resources/src/page-careers.html">View open positions</a>
                </div>
              </div>
              <!-- End Media -->
            </div>
    ...
    <div class="container content-space-b-2 content-space-b-lg-3 overflow-hidden">
      ...
      <div class="text-center">
        <a class="link link-pointer" href="#">View all clients</a>
      </div>
    </div>
    <!-- End Testimonials -->
    ...
    <!-- Card Grid -->
    <div class="overflow-hidden">
      <div class="container border-top border-bottom content-space-1 content-space-lg-3">
        <div class="row justify-content-lg-between">
