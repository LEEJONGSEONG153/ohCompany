...
<head>
  ...
  <!-- Title -->
  <title>Customer Stories | Unify - Multipurpose Responsive Template</title>
  ...
  <main id="content" role="main">
        ...
        <div class="row justify-content-lg-between align-items-md-center">
          <div class="col-md-6 col-lg-5 mb-10 mb-md-0">
            <div class="position-relative">
              <img class="img-fluid rounded-3" src="${path}/resources/src/assets/img/950x950/img8.jpg" alt="Image Description">
          ...
          <div class="col-md-6">
            ...
            <a class="btn btn-primary btn-pointer" href="${path}/resources/src/page-customer-story.jsp">Read story</a>
          </div>
          <!-- End Col -->
        </div>
        <!-- End Row -->
    ...
    <div class="container content-space-t-2 content-space-t-lg-3 content-space-b-lg-2">
      <div class="row row-cols-1 row-cols-sm-2 row-cols-md-3">
        <div class="col mb-5 mb-sm-10">
          <!-- Card -->
          <a class="card card-ghost card-transition-zoom h-100" href="${path}/resources/src/page-customer-story.jsp">
        ...
        <div class="col mb-5 mb-sm-10">
          ...
          <a class="card card-ghost card-transition-zoom h-100" href="${path}/resources/src/page-customer-story.jsp">
            <div class="card-transition-zoom-item">
              <img class="card-img" src="${path}/resources/src/assets/img/580x480/img10.jpg" alt="Image Description">
            </div>
    ...
    <div class="overflow-hidden">
      <div class="container content-space-b-1">
        <div class="row justify-content-lg-between align-items-md-center">
          <div class="col-md-6 col-lg-5 order-lg-2 mb-10 mb-md-0">
            <div class="position-relative">
              <img class="img-fluid rounded-3" src="${path}/resources/src/assets/img/950x950/img9.jpg" alt="Image Description">
          ...
          <div class="col-md-6">
            <div class="mb-5">
              <h2 class="h1">Reducing admin and providing a professional candidate experience for Grant Thornton</h2>
            </div>
            <a class="btn btn-primary btn-pointer" href="${path}/resources/src/page-customer-story.jsp">Read story</a>
          </div>
          <!-- End Col -->
    ...
    <!-- Card Grid -->
    <div class="container content-space-t-lg-2 content-space-b-1 content-space-b-lg-2">
      <div class="row row-cols-1 row-cols-sm-2 row-cols-md-3">
        <div class="col mb-5 mb-sm-10">
          <!-- Card -->
          <a class="card card-ghost card-transition-zoom h-100" href="${path}/resources/src/page-customer-story.jsp">
            <div class="card-transition-zoom-item">
              <img class="card-img" src="${path}/resources/src/assets/img/580x480/img12.jpg" alt="Image Description">
            </div>
            ...
            <div class="card-body">
              ...
              <h5>Brompton: Making tracks with global payments</h5>
            </div>
        ...
        <div class="col mb-5 mb-sm-10">
          ...
          <a class="card card-ghost card-transition-zoom h-100" href="${path}/resources/src/page-customer-story.jsp">
            <div class="card-pinned card-transition-zoom-item">
              <img class="card-img" src="${path}/resources/src/assets/img/580x480/img6.jpg" alt="Image Description">
              <span class="badge bg-dark text-white card-pinned-top-end">New startup</span>
            </div>

            <div class="card-body">
              <div class="mb-3">
                <img class="avatar avatar-lg avatar-4x3" src="${path}/resources/src/assets/svg/brands/shopify-dark.svg" alt="Logo">
              </div>
              <h5>Amanda Wakeley: Consolidating systems to power future growth</h5>
            </div>
        ...
        <div class="col mb-5 mb-sm-10">
          ...
          <a class="card card-ghost card-transition-zoom h-100" href="${path}/resources/src/page-customer-story.jsp">
            <div class="card-transition-zoom-item">
              <img class="card-img" src="${path}/resources/src/assets/img/580x480/img13.jpg" alt="Image Description">
            </div>

            <div class="card-body">
              <div class="mb-3">
                <img class="avatar avatar-lg avatar-4x3" src="${path}/resources/src/assets/svg/brands/layar-dark.svg" alt="Logo">
              </div>
              <h5>Bookbeat: How a Swedish audiobook app is reshaping publishing</h5>
            </div>
    ...
    <div class="container">
      <div class="w-lg-75 text-center mx-lg-auto">
        <div class="mb-5">
          <img class="avatar avatar-xl avatar-4x3" src="${path}/resources/src/assets/svg/brands/airbnb-dark.svg" alt="Logo">
        </div>
        
        <figure class="blockquote-lg">
          <blockquote class="blockquote">I just wanted to say that I'm very happy with my purchase of Unify so far. The documentation is outstanding - clear and detailed.</blockquote>

          <figcaption class="blockquote-footer mb-3 mb-sm-7">
            Philip
            <span class="blockquote-footer-source">Product Manager | Airbnb</span>
          </figcaption>
        </figure>
    ...
    <div class="container content-space-2 content-space-lg-3">
      <!-- Swiper Slider -->
      <div class="js-swiper-clients-2 swiper text-center">
        <div class="swiper-wrapper">
          <div class="swiper-slide">
            <img class="avatar avatar-lg avatar-4x3" src="${path}/resources/src/assets/svg/brands/google-dark.svg" alt="Logo">
          </div>
          <!-- End Slide -->
          ...
          <div class="swiper-slide">
            <img class="avatar avatar-lg avatar-4x3" src="${path}/resources/src/assets/svg/brands/airbnb-dark.svg" alt="Logo">
          </div>
          <!-- End Slide -->

          <div class="swiper-slide">
            <img class="avatar avatar-lg avatar-4x3" src="${path}/resources/src/assets/svg/brands/kaplan-dark.svg" alt="Logo">
          </div>
          <!-- End Slide -->
    ...
    <div class="overflow-hidden">
      <div class="container content-space-b-1">
        <div class="row justify-content-lg-between align-items-md-center">
          <div class="col-md-6 col-lg-5 mb-10 mb-md-0">
            <div class="position-relative">
              <img class="img-fluid rounded-3" src="${path}/resources/src/assets/img/950x950/img7.jpg" alt="Image Description">
          ...
          <div class="col-md-6">
            <div class="mb-5">
              <h1>Taking Everi's culture of respect and inclusion to the next level</h1>
            </div>
            <a class="btn btn-primary btn-pointer" href="${path}/resources/src/page-customer-story.jsp">Read story</a>
          </div>
          <!-- End Col -->
    ...
    <!-- Card Grid -->
    <div class="container content-space-t-lg-2 content-space-b-lg-2">
      <div class="row row-cols-1 row-cols-sm-2 row-cols-md-3">
        <div class="col mb-5 mb-sm-10">
          <!-- Card -->
          <a class="card card-ghost card-transition-zoom h-100" href="${path}/resources/src/page-customer-story.jsp">
            ...
            <div class="card-body">
              ...
              <h5>Recharge.com: Growing globally with Unify Acquiring</h5>
            </div>
        ...
        <div class="col mb-5 mb-sm-10">
          ...
          <a class="card card-ghost card-transition-zoom h-100" href="${path}/resources/src/page-customer-story.jsp">
            ...
            <div class="card-body">
              ...
              <h5>Watches of Switzerland: Timeless payments</h5>
            </div>
        ...
        <div class="col mb-5 mb-sm-10">
          ...
          <a class="card card-ghost card-transition-zoom h-100" href="${path}/resources/src/page-customer-story.jsp">
            <div class="card-pinned card-transition-zoom-item">
              <img class="card-img" src="${path}/resources/src/assets/img/580x480/img11.jpg" alt="Image Description">
              <span class="badge bg-dark text-white card-pinned-top-end">New startup</span>
            </div>

            <div class="card-body">
              <div class="mb-3">
                <img class="avatar avatar-lg avatar-4x3" src="${path}/resources/src/assets/svg/brands/business-insider-dark.svg" alt="Logo">
              </div>
              <h5>Athlinks &amp; Unify: In it for the long run</h5>
            </div>
